...
def main():
    ...
    raw_url = "https://web.archive.org/web/20251228112614id_/https://ketto.xsrv.jp/html/mimiken/clist.cgi?tvm47"
    ...
    for table in tables:
        ...
        for row in table_rows:  # Skip header row
                ...
                circle = Circle(
                    ...
                    links=[url.replace("https://web.archive.org/web/20251228112614/", "") for url in circle_urls] if circle_urls else None,
                    position=position,
