...
def main():
    ...
    raw_url = "https://web.archive.org/web/20250415182928id_/https://ketto.xsrv.jp/html/mimiken/clist.cgi?tvm45"
    ...
    for table in tables:
        ...
        for row in table_rows:  # Skip header row
                ...
                circle = Circle(
                    ...
                    links=[url.replace("https://web.archive.org/web/20250415182928/", "") for url in circle_urls] if circle_urls else None,
                    position=position,
