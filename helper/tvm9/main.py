...
def main():
    ...
    raw_url = "https://web.archive.org/web/20101219162826id_/http://ketto.com/mimiken/alllist.cgi?9"
    ...
    for table in tables:
        ...
        for row in table_rows:  # Skip header row
                ...
                circle = Circle(
                    ...
                    links=[url.replace("https://web.archive.org/web/20101219162826/", "") for url in circle_urls] if circle_urls else None,
                    position=position,
