...
def main():
    ...
    raw_url = "https://web.archive.org/web/20110713145157id_/http://ketto.com/mimiken/alllist.cgi?19"
    ...
    for table in tables:
        ...
        for row in table_rows:  # Skip header row
                ...
                circle = Circle(
                    ...
                    links=[url.replace("https://web.archive.org/web/20110713145157/", "") for url in circle_urls] if circle_urls else None,
                    position=position,
