...
def main():
    ...
    raw_url = "https://web.archive.org/web/20250316134417id_/https://ketto.xsrv.jp/html/mimiken/clist.cgi?tvm59"
    ...
    for table in tables:
        ...
        for row in table_rows:  # Skip header row
                ...
                circle = Circle(
                    ...
                    links=[url.replace("https://web.archive.org/web/20250316134417/", "") for url in circle_urls] if circle_urls else None,
                    position=position,
