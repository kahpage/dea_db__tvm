...
def main():
    ...
    raw_url = "https://web.archive.org/web/20140701163534id_/http://ketto.com/mimiken/alist2.cgi?67"
    ...
    for table in tables:
        ...
        for row in table_rows:  # Skip header row
                ...
                circle = Circle(
                    ...
                    links=[url.replace("https://web.archive.org/web/20140701163534/", "") for url in circle_urls] if circle_urls else None,
                    position=position,
