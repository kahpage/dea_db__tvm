...
def main():
    ...
    raw_url = "https://web.archive.org/web/20170317005530id_/http://ketto.com/mimiken/alist2.cgi?144,%83%7B%81%5B%83%7D%83X36"
    ...
    for table in tables:
        ...
        for row in table_rows:  # Skip header row
                ...
                circle = Circle(
                    ...
                    links=[url.replace("https://web.archive.org/web/20170317005530/", "") for url in circle_urls] if circle_urls else None,
                    position=position,
