...
def main():
    ...
    raw_url = "https://web.archive.org/web/20230619084605id_/https://ketto.xsrv.jp/html/mimiken/clist.cgi?tvm52"
    ...
    for table in tables:
        ...
        for row in table_rows:  # Skip header row
                ...
                circle = Circle(
                    ...
                    links=[url.replace("https://web.archive.org/web/20230619084605/", "") for url in circle_urls] if circle_urls else None,
                    position=position,
