...
def main():
    ...
    raw_url = "https://web.archive.org/web/20141211002218id_/http://ketto.com/mimiken/alist2.cgi?134"
    ...
    for table in tables:
        ...
        for row in table_rows:  # Skip header row
                ...
                circle = Circle(
                    ...
                    links=[url.replace("https://web.archive.org/web/20141211002218/", "") for url in circle_urls] if circle_urls else None,
                    position=position,
