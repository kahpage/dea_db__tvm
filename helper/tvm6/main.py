...
def main():
    ...
    raw_url = "https://web.archive.org/web/20110603034917id_/http://ketto.com/mimiken/alllist.cgi?186"
    ...
    for table in tables:
        ...
        for row in table_rows:  # Skip header row
                ...
                circle = Circle(
                    ...
                    links=[url.replace("https://web.archive.org/web/20110603034917/", "") for url in circle_urls] if circle_urls else None,
                    position=position,
