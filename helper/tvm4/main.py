...
def main():
    ...
    raw_url = "https://web.archive.org/web/20110603040450id_/http://ketto.com/mimiken/alllist.cgi?173"
    ...
    for table in tables:
        ...
        for row in table_rows[1:]:  # Skip header row
                ...
                circle = Circle(
                    ...
                    links=[url.replace("https://web.archive.org/web/20110603040450/", "") for url in circle_urls] if circle_urls else None,
                    position=position,
