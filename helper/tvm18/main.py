...
def main():
    ...
    raw_url = "https://web.archive.org/web/20120307012434id_/http://ketto.com/mimiken/alllist.cgi?59"
    ...
    for table in tables:
        ...
        for row in table_rows:  # Skip header row
                ...
                circle = Circle(
                    ...
                    links=[url.replace("https://web.archive.org/web/20120307012434/", "") for url in circle_urls] if circle_urls else None,
                    position=position,
